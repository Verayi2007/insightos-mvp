...
InsightOS 是一个本地优先的 AI 知识消化驾驶舱，目标是把高质量商业阅读转化为文章卡片、思维决策模型、机构/财报索引和复盘问题。
...
- 决策模型：自动提取文章中使用的思维决策模型，并列出同模型下的相关文章
- 机构报告：提取文章涉及的咨询机构、投研机构、财报、行业报告和白皮书，并列出同来源下的相关文章
...
- 接入 SQLite 保存长期知识资产
- 增加 AI processor，自动抽取思维决策模型、机构/财报、观点和决策启发
- 增加定时同步和每周复盘生成
- 支持更多知识库来源
